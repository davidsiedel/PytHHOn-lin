...
def solve_2D_incompressible_problem(
    ...
    # ------------------------------------------------------------------------------------------------------------------
    dirichlet_x_bottom = lambda s: s[0]
    dirichlet_y_bottom = lambda s: s[0]
    # ------------------------------------------------------------------------------------------------------------------
    dirichlet_x_top = lambda s: s[0] + 1.0
    dirichlet_y_top = lambda s: s[0] + 1.0
    # ------------------------------------------------------------------------------------------------------------------
    dirichlet_x_left = lambda s: s[0] + 1.0
    dirichlet_y_left = lambda s: s[0] + 1.0
    # ------------------------------------------------------------------------------------------------------------------
    dirichlet_x_right = lambda s: s[0]
    dirichlet_y_right = lambda s: s[0]
    # ------------------------------------------------------------------------------------------------------------------
