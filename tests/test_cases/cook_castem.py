...
def solve(
    ...
    for cell_index in cells_indices:
        ...
        tangent_matrix = tangent_matrix[:-1, :-1]
        ...
        for i in range(tangent_matrix.shape[0]):
            for j in range(tangent_matrix.shape[1]):
                if i == j:
                    ...
                    cff = 2.0
                m = cff * tangent_matrix[i, j] * m_phi_phi_cell
                # ------------------------------------------------------------------------------------------------------
        ...
        log_grad = local_gradient_operator[: -cell_basis_k.basis_dimension, :]
        local_stiffness_form = log_grad.T @ local_mass_matrix @ log_grad
        # --------------------------------------------------------------------------------------------------------------
