/*!
* \file   TFEL/Material/ElasticityIntegrationData.hxx
* \brief  this file implements the ElasticityIntegrationData class.
*         File generated by tfel version 3.4.0-dev
* \author Helfer Thomas
* \date   23 / 11 / 06
 */

#ifndef LIB_TFELMATERIAL_ELASTICITY_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_ELASTICITY_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const ElasticityIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class ElasticityIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const ElasticityIntegrationData&);
...
*/
ElasticityIntegrationData()
{}

/*!
* \brief Copy constructor
*/
ElasticityIntegrationData(const ElasticityIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
ElasticityIntegrationData(const mfront::gb::BehaviourData& mgb_d)
: dt(mgb_d.dt),
...
ElasticityIntegrationData&
>::type
scale(const ElasticityBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
ElasticityIntegrationData&
updateDrivingVariables(const ElasticityBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of ElasticityIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const ElasticityIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_ELASTICITY_INTEGRATION_DATA_HXX */
