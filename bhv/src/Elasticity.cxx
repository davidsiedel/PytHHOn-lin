...
ElasticityParametersInitializer::get()
{
static ElasticityParametersInitializer i;
return i;
}
...
ElasticityParametersInitializer::readParameters(*this,"Elasticity-parameters.txt");
}

void
ElasticityParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("ElasticityParametersInitializer::set: "
" no parameter named '"+std::string(key)+"'");
}
}

double
ElasticityParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"ElasticityParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

void
ElasticityParametersInitializer::readParameters(ElasticityParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(c,"ElasticityParametersInitializer::readParameters: "
...
pi.minimal_time_step_scaling_factor = ElasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = ElasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else {
