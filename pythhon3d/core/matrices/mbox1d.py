...
class Mbox:
    ...
    def compute_hybrid_matrices(
        ...
        for mface in mfaces:
            mat_F_grad_phi_k1_psi_k_x = Integration.get_hybrid_advection_matrix_in_face(
                mcell.cell,
                mface.face,
                cell_basis_k1,
                face_basis_k,
            ...
            # ------------------------------------------------------------------------------------------------------
            mat_F_phi_l_grad_phi_k1_x = Integration.get_cell_advection_matrix_in_face(
                mcell.cell, mface.face, cell_basis_l, cell_basis_k1, 0
            )
            mat_F_grad_phi_k1_phi_l_x = mat_F_phi_l_grad_phi_k1_x.T
            # ------------------------------------------------------------------------------------------------------
            mat_F_grad_phi_k1_psi_k_j_list = [mat_F_grad_phi_k1_psi_k_x]
            mat_F_grad_phi_k1_phi_l_j_list = [mat_F_grad_phi_k1_phi_l_x]
        # ==============================================================================================================
    ...
    def compute_cell_matrices(self, cell: Cell, cell_basis_l: Basis, cell_basis_k: Basis, cell_basis_k1: Basis):
        """
        ================================================================================================================
        Method :
        ================================================================================================================
        ...
        mat_T_grad_phi_k1_grad_phi_k1_inv_list = [mat_T_grad_phi_k1_grad_phi_k1_x]
        # --------------------------------------------------------------------------------------------------------------
        # right-hand side
        # --------------------------------------------------------------------------------------------------------------
