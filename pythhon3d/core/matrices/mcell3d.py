...
class Mcell2D:
    def __init__(
        ...
        mat_T_phi_k_grad_phi_l_z = Integration.get_cell_advection_matrix_in_cell(cell, cell_basis_k, cell_basis_l, 2)
        mat_T_phi_k_grad_phi_l_list = [mat_T_phi_k_grad_phi_l_x, mat_T_phi_k_grad_phi_l_y, mat_T_phi_k_grad_phi_l_z]
        # ==============================================================================================================
        ...
        mat_T_grad_phi_k1_grad_phi_k1_z = Integration.get_cell_stiffness_matrix_in_cell(
            cell, cell_basis_k1, cell_basis_k1, 2
        )
        mat_T_grad_phi_k1_grad_phi_k1_inv_list = [
            mat_T_grad_phi_k1_grad_phi_k1_x,
            mat_T_grad_phi_k1_grad_phi_k1_y,
            mat_T_grad_phi_k1_grad_phi_k1_z,
        ]
        # --------------------------------------------------------------------------------------------------------------
        # right-hand side
        # --------------------------------------------------------------------------------------------------------------
        ...
        mat_T_phi_l_grad_phi_k1_z = Integration.get_cell_advection_matrix_in_cell(cell, cell_basis_l, cell_basis_k1, 2)
        mat_T_grad_phi_k1_phi_l_list = [mat_T_phi_l_grad_phi_k1_x, mat_T_phi_l_grad_phi_k1_y, mat_T_phi_l_grad_phi_k1_z]
        # ==============================================================================================================
