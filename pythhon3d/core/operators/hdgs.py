...
class HDGs(Operator):
    ...
    def get_local_gradient_operator0(
        self,
        cell: Cell,
        faces: List[Face],
        cell_basis_l: Basis,
        ...
        for j in derivative_directions:
            ...
            for f, face in enumerate(faces):
                ...
                for i in directions:
                    ...
                    # c0_Tj = j * cell_basis_l.basis_dimension
                    # c1_Tj = (j + 1) * cell_basis_l.basis_dimension
                    # --------------------------------------------------------------------------------------------------
                    ...
                    # local_gradient_operator[r0:r1, c0_T:c1_T] += 0.5 * m_cell_phi_k_grad_phi_l
                    # local_gradient_operator[r0:r1, c0_Tj:c1_Tj] += 0.5 * m_cell_phi_k_grad_phi_l
            for i in directions:
                line = self.get_line_from_indices(i, j, unknown)
                r0 = line * cell_basis_k.basis_dimension
                r1 = (line + 1) * cell_basis_k.basis_dimension
                ...
                c1_Tj = (j + 1) * cell_basis_l.basis_dimension
                #
                m_cell_phi_k_grad_phi_l_j = Integration.get_cell_advection_matrix_in_cell(
                    cell, cell_basis_k, cell_basis_l, j
                )
                m_cell_phi_k_grad_phi_l_i = Integration.get_cell_advection_matrix_in_cell(
                    cell, cell_basis_k, cell_basis_l, i
                )
                #
                local_gradient_operator[r0:r1, c0_T:c1_T] += 0.5 * m_cell_phi_k_grad_phi_l_j
                local_gradient_operator[r0:r1, c0_Tj:c1_Tj] += 0.5 * m_cell_phi_k_grad_phi_l_i
    ...
    def get_local_gradient_operator(
        ...
        for i in directions:
            for j in derivative_directions:
                ...
                #
                # local_gradient_operator[r0:r1, c0_T:c1_T] += m_cell_phi_k_grad_phi_l_j
                local_gradient_operator[r0:r1, c0_T:c1_T] += 0.5 * m_cell_phi_k_grad_phi_l_j
                local_gradient_operator[r0:r1, c0_Tj:c1_Tj] += 0.5 * m_cell_phi_k_grad_phi_l_i
                local_gradient_operator[r0:r1, :] = m_cell_phi_k_phi_k_inv @ local_gradient_operator[r0:r1, :]
        return local_gradient_operator
